...
use crate::thread_safe_rand_agent::ThreadSafeRandAgentBuilder;
...
impl ThreadSafeRandAgentBuilder{
    /// 简单构建器
    pub fn simple_builder(mut self, agent_configs: Vec<AgentConfig>,global_system_prompt: String) -> Self {
